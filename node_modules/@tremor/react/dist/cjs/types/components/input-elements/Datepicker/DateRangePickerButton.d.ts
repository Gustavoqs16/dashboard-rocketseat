...
declare const DateRangePickerButton: ({ value, options, placeholder, calendarRef, showCalendar, setShowCalendar, onCalendarKeyDown, enableDropdown, dropdownRef, showDropdown, setShowDropdown, onDropdownKeyDown, locale, dropdownPlaceholder, }: DateRangePickerButtonProps) => JSX.Element;
