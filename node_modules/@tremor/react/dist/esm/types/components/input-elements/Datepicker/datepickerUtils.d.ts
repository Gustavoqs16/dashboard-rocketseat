...
export declare const getInitialDateRange: (defaultStartDate: Date | null, defaultEndDate: Date | null, minDate: Date | null, maxDate: Date | null, hasDefaultDateRange: boolean) => (Date | null)[];
export declare const getInitialCurrentMonth: (initialEndDate: Date | null, maxDate: Date | null) => string;
export declare const isDayDisabled: (day: Date, minDate: Date | null, maxDate: Date | null, firstDayCurrentMonth: Date, lastDayCurrentMonth: Date) => boolean;
...
export declare const getStartDateFromRelativeFilterOption: (selectedRelativeFilterOption: RelativeFilterOption) => Date;
export declare const colStartClasses: string[];
export declare const previousYear: (firstDayCurrentMonth: Date, setCurrentMonth: React.Dispatch<React.SetStateAction<string>>) => void;
export declare const nextYear: (firstDayCurrentMonth: Date, setCurrentMonth: React.Dispatch<React.SetStateAction<string>>) => void;
